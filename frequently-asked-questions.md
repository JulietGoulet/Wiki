...
There is currently no way for you to find out the number of records that will be inserted/updated/deleted if you run a CLI without performing the sync.
...
![Image 2: How to clone a domain](<.gitbook/assets/image (320).png>)
...
![Image 3: 0 records](<.gitbook/assets/image (313).png>)
